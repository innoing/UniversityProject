...
public class BlackandWhiteServerSide_GUI extends JFrame {
	   ...
	   int point = 0;
	   public BlackandWhiteServerSide_GUI(int RandomNumber, String username) {
	   ...
	   void GUI() {
	        ...
	        setTitle("더 지니어스 : 룰 브레이커 흑 과 백 (Java Edition) Player 1");
	        ...
	        JLabel label2 = new JLabel("Player 1 UserName: " + username2);
    ...
    public void initSocket() {
		try {
			server_socket = new ServerSocket(10001);
    ...
    public void sendInformation(JButton jb) {
		...
		//System.out.println("Received Data From Client: " + r_thread.receiveString());
